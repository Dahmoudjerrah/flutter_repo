...
//             onTap: () {
//               Get.back();
//               controller.showCabinetList.value = true;
//             },
//           ),
//           ListTile(
...
//             onTap: () {
//               Get.back();
//               controller.showCabinetList.value = false;
//             },
//           ),
//         ],
//       ),
...
//     return Obx(() => controller.showCabinetList.value
//         ? _buildCabinetList()
//         : _buildMapView());
//   }
//
...
//                 items: controller.willayaDropdownItems,
//                 onChanged: controller.onWillayaChanged,
//                 decoration: inputDecoration('Sélectionner une Willaya'),
//               )),
//         ),
//         const SizedBox(width: 16),
//         Expanded(
...
//                 items: controller.moughataaDropdownItems,
//                 onChanged: controller.onMoughataaChanged,
//                 decoration: inputDecoration('Sélectionner une Moughataa'),
//               )),
//         ),
//       ],
//     );
//   }
//
//   Widget _buildCabinetListView() {
//     return Obx(() {
//       final paginatedCabinets = controller.getPaginatedCabinets();
//       return ListView.builder(
//         itemCount: paginatedCabinets.length,
//         itemBuilder: (context, index) {
//           final cabinet = paginatedCabinets[index];
//           return ListTile(
//             title: Text(
//               cabinet.nom,
//               style: const TextStyle(
